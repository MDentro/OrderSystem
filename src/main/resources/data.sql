...
(1003, 'MIXTUR', 4.99, 'cooking', 'Timeless oven dish in clear glass that you can take directly from the oven and put on the table. Dishwasher-, oven- and microwave-safe. Two small handles make it easy to lift and carry – with potholders as protection of course.'),
...
(1005, 'MAGASIN', 4.99, 'baking', 'Helps you roll out the dough when baking buns, bread or creating a tasty pizza base. Simple to clean – just wipe dry with a damp cloth.'),
(1006, 'VARDAGEN', 5.99, 'baking', 'Help you get the right amount of spices, flour or other flavourings when cooking or baking. Take up little storage space since the dimensions fit in each other. Feel free to hang them on a hook over the kitchen worktop so you always have them close at hand.');
